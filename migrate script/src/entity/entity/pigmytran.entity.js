...
var PIGMYTRAN = /** @class */ (function () {
    ...
    PIGMYTRAN = __decorate([
        ...
        (0, typeorm_1.Index)("NDXPIGMYTRAN", ["BRANCH_CODE", "TRAN_DATE", "TRAN_ACNOTYPE", "TRAN_ACTYPE", "TRAN_ACNO"]),
        (0, typeorm_1.Index)("NDXPIGMYTRAN1", ["BRANCH_CODE", "TRAN_DATE", "TRAN_NO", "SERIAL_NO"])
    ], PIGMYTRAN);
    return PIGMYTRAN;
}());
