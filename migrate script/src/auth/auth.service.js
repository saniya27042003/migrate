...
var system_entity_1 = require("../utility/user-defination/entity/system.entity");
var user_defination_entity_1 = require("../utility/user-defination/entity/user-defination.entity");
var typeorm_1 = require("@nestjs/typeorm");
var AuthService = /** @class */ (function () {
    function AuthService(usersService, systemMaster, userdefination, jwtService) {
        this.usersService = usersService;
        this.systemMaster = systemMaster;
        this.userdefination = userdefination;
    ...
    AuthService.prototype.login = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var system_master, payload;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.systemMaster.find()];
                    case 1:
                        system_master = _a.sent();
    ...
    AuthService = __decorate([
        ...
        __param(1, (0, typeorm_1.InjectRepository)(system_entity_1.System_master)),
        __param(2, (0, typeorm_1.InjectRepository)(user_defination_entity_1.USERDEFINATION))
    ], AuthService);
    return AuthService;
}());
